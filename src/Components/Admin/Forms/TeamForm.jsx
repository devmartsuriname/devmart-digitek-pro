          ...
          <form onSubmit={handleSubmit(onFormSubmit)}>
            <div className="row g-3">
              ...
              <div className="col-md-6">
                <label htmlFor="team-name" className="form-label text-white">Name *</label>
                <input
                  type="text"
                  id="team-name"
                ...
                />
                {errors.name && (
                  <div id="team-name-error" className="invalid-feedback" role="alert">
                    {errors.name.message}
                  </div>
                )}
              </div>
              ...
              {/* Slug */}
              <div className="col-md-6">
                <label htmlFor="team-slug" className="form-label text-white">Slug *</label>
                <input
                  type="text"
                  id="team-slug"
                  ...
                  aria-describedby={errors.slug ? 'team-slug-error' : undefined}
                />
                {errors.slug && (
                  <div id="team-slug-error" className="invalid-feedback" role="alert">
                    {errors.slug.message}
                  </div>
                )}
              </div>
              ...
              {/* Role */}
              <div className="col-md-6">
                <label htmlFor="team-role" className="form-label text-white">Role</label>
                <input
                  type="text"
                  id="team-role"
                  ...
                  aria-describedby={errors.role ? 'team-role-error' : undefined}
                />
                {errors.role && (
                  <div id="team-role-error" className="invalid-feedback" role="alert">
                    {errors.role.message}
                  </div>
                )}
              </div>
              ...
              {/* Order */}
              <div className="col-md-6">
                <label htmlFor="team-order" className="form-label text-white">Display Order</label>
                <input
                  type="number"
                  id="team-order"
                  ...
                  aria-describedby={errors.order_num ? 'team-order-error' : undefined}
                />
                {errors.order_num && (
                  <div id="team-order-error" className="invalid-feedback" role="alert">
              ...
              <div className="col-12">
                <label htmlFor="team-photo-url" className="form-label text-white">Photo URL</label>
                <input
                  type="text"
                  id="team-photo-url"
                  ...
                  aria-describedby={errors.photo_url ? 'team-photo-url-error' : undefined}
                />
                {errors.photo_url && (
                  <div id="team-photo-url-error" className="invalid-feedback" role="alert">
...
...
              ...
              {/* Bio */}
              <div className="col-12">
                <label htmlFor="team-bio" className="form-label text-white">Bio</label>
                <textarea
                  id="team-bio"
                  ...
                  aria-describedby={errors.bio ? 'team-bio-error' : undefined}
                />
                {errors.bio && (
                  <div id="team-bio-error" className="invalid-feedback" role="alert">
                    {errors.bio.message}
                  </div>
                )}
              </div>
