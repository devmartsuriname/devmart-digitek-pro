...
const Blog4 = () => {
    ...
    if (error) {
        return (
            <section className="news-section section-padding fix">
                <div className="container">
                    <div className="alert alert-danger">Failed to load blog posts. Please try again later.</div>
                </div>
            </section>
        );
    }
    ...
    if (blogPosts.length === 0) {
        return (
            <section className="news-section section-padding fix">
                <div className="container">
                    <div className="alert alert-info">No blog posts available at this time.</div>
                </div>
            </section>
        );
    }
                    ...
                    <div key={post.id} className="col-xl-4 col-lg-6 col-md-6">
                        <div className="news-box-items mt-0">
                            <div className="news-image wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.2s">
                                <img src={post.cover_url || '/assets/img/news/01.jpg'} alt={post.title} />
                            </div>
                            <div className="news-content">
                                ...
                                <div className="news-btn">
                                    <Link to={`/blog/${post.slug}`} className="link-btn">Read More <i className="bi bi-arrow-right"></i></Link>
